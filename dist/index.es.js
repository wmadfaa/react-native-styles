...
function createPalette(options) {
    var _a = options.primary, primary = _a === void 0 ? {
        ...
        main: pink.A400,
        dark: pink.A700
    } : _b, _c = options.error, error = _c === void 0 ? {
        light: red[300],
        main: red[500],
        dark: red[700]
    } : _c, _d = options.type, type = _d === void 0 ? "light" : _d, _e = options.contrastThreshold, contrastThreshold = _e === void 0 ? 3 : _e, _f = options.tonalOffset, tonalOffset = _f === void 0 ? 0.2 : _f, other = __rest(options, ["primary", "secondary", "error", "type", "contrastThreshold", "tonalOffset"]);
    ...
    return cjs(__assign({ common: common,
        type: type, primary: augmentColor(primary), secondary: augmentColor(secondary, "A400", "A200", "A700"), error: augmentColor(error), grey: grey,
...
var createTypography = function (options) {
    var _a = options.rem, rem = _a === void 0 ? 14 : _a, _b = options.allVariants, allVariants = _b === void 0 ? {} : _b;
    var buildVariant = function (em, lineHeight, casing) {
        var fontSize = rem * em;
        console.log(lineHeight);
        return __assign({ fontSize: fontSize, 
            // lineHeight: 1, // lineHeight * fontSize,
            textTransform: casing }, allVariants);
    };
    var variants = {
...
(function (themeManager) {
    function create(themeOptions) {
        var _a = themeOptions.palette, paletteInput = _a === void 0 ? {} : _a, _b = themeOptions.typography, typographyInput = _b === void 0 ? {} : _b, spacingInput = themeOptions.spacing, shadowsInput = themeOptions.shadows, others = __rest(themeOptions, ["palette", "typography", "spacing", "shadows"]);
        var palette = createPalette(paletteInput);
        var typography = createTypography(typographyInput);
        var spacing = createSpacing(spacingInput);
        var shadows$1 = shadowsInput || shadows;
        return cjs({ palette: palette, typography: typography, spacing: spacing, shadows: shadows$1, shape: shape }, __assign({}, others));
    }
...
(function (themeContext) {
    ...
    themeContext.provider = function (_a) {
        ...
        return React.createElement(themeContext.context.Provider, { value: themeValue }, children);
    };
...
var createStyleSheet = function (styles) {
    ...
    var withStyles = function (styles_props) { return function (Component) { return function (props) {
        var theme = useTheme();
        return React.createElement(Component, __assign({}, props, { styles: get_Styles(theme, styles_props) }));
    }; }; };
    return { useStyles: useStyles, withStyles: withStyles };
};

var Context = themeContext$1.context;
var withTheme = function (Component) { return function (props) {
    return (React.createElement(Context.Consumer, null, function (value) { return React.createElement(Component, __assign({}, props, { theme: value })); }));
}; };

export { createStyleSheet, themeContext$1 as themeContext, themeManager$1 as themeManager, useTheme, withTheme };
